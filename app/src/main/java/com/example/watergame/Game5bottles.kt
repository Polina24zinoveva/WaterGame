...
private const val countBottle = 5
...
private var colors = arrayOf("0", "0", "0", "0")
private val colorsRainbow = arrayOf("#174ea9", "#BC2F82", "#f0ca3e", "#3fb39d")
private val colorsPink = arrayOf("#af2156", "#f5a3c6", "#ec4a9b", "#db60a4")
private val colorsBLue = arrayOf("#001b6d", "#82b3dc", "#009fd3", "#00507d")
private val colorsGreen = arrayOf("#2d953e", "#005335", "#c5e1a4", "#01ae81")
private val colorsRed = arrayOf("#e60026", "#66000b", "#dd6a52", "#b2243a")


private val bottles = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
...
<color name="yellow">#EBFF36</color>*/
...
class Game5bottles : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game5bottles)
        ...
        if (outplayClick) {
            ...
            val sharedPref4 = getSharedPreferences("my_preferences4", Context.MODE_PRIVATE)

            firstBottleString = sharedPref4.getString("firstBottleString", "").toString()
            secondBottleString = sharedPref4.getString("secondBottleString", "").toString()
            thirdBottleString = sharedPref4.getString("thirdBottleString", "").toString()
            ...
            val countColorsInBottle = mutableListOf(mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>())
    ...
    private fun changeStyleAndTheme(){
        ...
        if (!colors.contentEquals(oldColors)) {
            ...
            val bottlesWithNewStyleColors = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
