...
private const val countBottle = 9
...
private var colors = arrayOf("0", "0", "0", "0", "0", "0", "0", "0")
...
private val bottles = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
...
class Game9bottles : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game9bottles)
    ...
    private fun changeStyleAndTheme(){
        ...
        if (!colors.contentEquals(oldColors)) {
            ...
            val bottlesWithNewStyleColors = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
