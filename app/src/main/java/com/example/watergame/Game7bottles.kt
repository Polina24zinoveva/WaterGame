...
private const val countBottle = 7
...
private var colors = arrayOf("0", "0", "0", "0", "0", "0")
private val colorsRainbow = arrayOf("#174ea9", "#BC2F82", "#f0ca3e", "#3fb39d", "#f24e4a", "#d07c1d")
private val colorsPink = arrayOf("#af2156", "#f5a3c6", "#ec4a9b", "#db60a4", "#f8d0d0", "#822566")
private val colorsBLue = arrayOf("#001b6d", "#82b3dc", "#009fd3", "#00507d", "#5861a4", "#004a55")
private val colorsGreen = arrayOf("#2d953e", "#005335", "#c5e1a4", "#01ae81", "#004123", "#0b9051")
private val colorsRed = arrayOf("#e60026", "#66000b", "#dd6a52", "#b2243a", "#a73b2f", "#560122")


private val bottles = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
...
class Game7bottles : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game7bottles)
        ...
        if (outplayClick) {
            ...
            val sharedPref6 = getSharedPreferences("my_preferences6", Context.MODE_PRIVATE)

            firstBottleString = sharedPref6.getString("firstBottleString", "").toString()
            secondBottleString = sharedPref6.getString("secondBottleString", "").toString()
            thirdBottleString = sharedPref6.getString("thirdBottleString", "").toString()
            fourthBottleString = sharedPref6.getString("fourthBottleString", "").toString()
            fifthBottleString = sharedPref6.getString("fifthBottleString", "").toString()
            ...
            val countColorsInBottle = mutableListOf(mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>())
    ...
    private fun changeStyleAndTheme(){
        ...
        if (!colors.contentEquals(oldColors)) {
            ...
            val bottlesWithNewStyleColors = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
