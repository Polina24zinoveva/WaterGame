...
private const val countBottle = 4
...
private var colors = arrayOf("0", "0", "0")
private val colorsRainbow = arrayOf("#174ea9", "#BC2F82", "#f0ca3e")
private val colorsPink = arrayOf("#af2156", "#f5a3c6", "#ec4a9b")
private val colorsBLue = arrayOf("#001b6d", "#82b3dc", "#009fd3")
private val colorsGreen = arrayOf("#2d953e", "#005335", "#c5e1a4")
private val colorsRed = arrayOf("#e60026", "#66000b", "#dd6a52")


private val bottles = mutableListOf(mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>(), mutableListOf<String>())
...
class Game4bottles : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game4bottles)
        ...
        if (outplayClick) {
            ...
            val countColorsInBottle = mutableListOf(mutableListOf<Int>(), mutableListOf<Int>(), mutableListOf<Int>())
            for (j in 0..countBottle - countEmptyBottle - 1) { //иду по бутылкам
                for (i in 0..3) {            //иду по ячейкам цвета(их 4)
                    ...
                    else {           //если задействовано 4 ячейки одного цвета
                        for (k in 0..countColors - 1) { //иду по цветам
                            if (countColorsInBottle[k].size < 4  && k != randomValue){
                                bottles[j] += colors[k]
                                countColorsInBottle[k].add(j)
